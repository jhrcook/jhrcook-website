...
subtitle: "My experience taking on the Western Native Trout Challenge to explore the greatest waters in the country."
summary: "My experience taking on the Western Native Trout Challenge to explore the greatest waters in the country."
tags: ["fishing"]
categories: ["Hobbies"]
...
{{< gallery >}}
  <img src="./assets/landscape.jpeg" class="grid-w100 md:grid-w100 xl:grid-w50" />
  <img src="./assets/dad-landscape.jpeg" class="grid-w100 md:grid-w100 xl:grid-w50" />
  <img src="./assets/stream.jpeg" class="grid-w50 md:grid-w50 xl:grid-w50" />
  <img src="./assets/plaque.jpeg" class="grid-w50 md:grid-w50 xl:grid-w50" />
  <img src="./assets/gila-trout.jpeg" class="grid-w100 md:grid-w100 xl:grid-w100" />
{{< /gallery >}}
